...
// ==========================================
// ASSINATURA RECORRENTE (GATILHO DIRETO)
// ==========================================
...
document.getElementById('btn-show-card').addEventListener('click', () => {
    Swal.fire({ 
        title: 'Abrindo o Cofre...', 
        text: 'Indo para o ambiente seguro do Mercado Pago.', 
        background: '#161618', 
        color: '#fff', 
        didOpen: () => { Swal.showLoading() } 
    });

    // 🔥 O seu link oficial e blindado do Mercado Pago!
    const LINK_DO_PLANO = "https://www.mercadopago.com.br/subscriptions/checkout?preapproval_plan_id=867728a336404feca158d63874ccea3b";

    // O golpe final: Redireciona o aluno direto para a tela de pagamento
    setTimeout(() => {
        window.location.href = LINK_DO_PLANO;
    }, 1500); // Um tempinho só para a animação do cofre rodar bonita
});
