...
async function processarPagamentoCartao(formData, resolve, reject) {
    ...
    try {
        // 🔥 DEFESA CONTRA CAMPOS INVISÍVEIS (O tropeço estava aqui)
        let emailAluno = "aluno@4lacademy.com"; // Email padrão de segurança
        let docTipo = "CPF";
        ...
        // Agora sim, manda o soco para o Supabase
        ...
        // 🔥 O NOSSO VAR: Se quebrar de novo, ele mostra o erro exato do celular!
